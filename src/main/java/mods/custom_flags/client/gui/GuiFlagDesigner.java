...
import mods.custom_flags.client.gui.controls.canvus_tools.CircleTool;
...
import mods.custom_flags.client.gui.controls.canvus_tools.RectangleTool;
import mods.custom_flags.client.gui.controls.canvus_tools.TextTool;
...
//        tools[4] = new EyeDropperTool();
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        ...
        if(par1GuiButton.id >=10 && par1GuiButton.id < 10+toggleButtons.length){
            ...
            slider.dragging = selectedTool instanceof FloodFillTool;
